# save_dashboard_html.py
"""
Script per salvare il contenuto HTML della dashboard da artifact
"""

def get_dashboard_html():
    """Ritorna il contenuto HTML completo della dashboard"""
    return '''<!DOCTYPE html>
<html lang="it">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        async function makeAPICall(endpoint, options = {}) {
            ...
            try {
                ...
                logMessage(`Errore API: ${error.message}`, 'error');
                throw error;
            }
        }
        ...
        async function updateSystemStatus() {
            try {
                const response = await makeAPICall('/api/status');
                ...
                if (response.success) {
                    ...
                    document.getElementById('content-count').textContent = data.sources_with_content || 0;
                ...
                document.getElementById('api-status').textContent = '🔴';
                document.getElementById('api-status-text').textContent = 'Errore';
        ...
        async function runSetup() {
            ...
            try {
                ...
                await makeAPICall('/api/setup/full', { method: 'POST' });
        ...
        async function executeImport() {
            ...
            try {
                ...
                const response = await fetch(`${API_BASE_URL}/api/import/file`, {
                    method: 'POST',
                    body: formData
                });
        ...
        function showCrawlerModal() {
            ...
            makeAPICall('/api/projects').then(response => {
        ...
        async function executeCrawler() {
            ...
            try {
                ...
                await makeAPICall('/api/crawler/run', {
                    method: 'POST',
                    body: {
                        project_id: project,
                        mode: mode,
                        max_workers: parseInt(workers)
                    }
                });
        ...
        async function crawlSingleSource() {
            ...
            try {
                ...
                await makeAPICall(`/api/crawler/source/${sourceId}`, { method: 'POST' });
        ...
        async function executeNLP() {
            ...
            try {
                ...
                await makeAPICall('/api/nlp/analyze', {
                    method: 'POST',
                    body: {
        ...
        async function extractEntities() {
            try {
                ...
                await makeAPICall('/api/nlp/entities', { method: 'POST' });
        ...
        async function runMaintenance() {
            ...
            try {
                ...
                await makeAPICall('/api/maintenance/run', { method: 'POST' });
        ...
        async function batchImport() {
            try {
                ...
                await makeAPICall('/api/import/batch', { method: 'POST' });
...
def save_dashboard_file():
    """Salva il file dashboard.html nel progetto"""
    import os
    ...
    try:
        ...
        print(f"✅ Dashboard salvata in: {dashboard_path.absolute()}")
        print(f"📁 Dimensione file: {len(html_content):,} caratteri")
        
        # Verifica che il file sia stato creato correttamente
        if dashboard_path.exists():
            print("✅ File verificato e pronto per l'uso")
...
if __name__ == "__main__":
    print("📄 Salvataggio file dashboard.html...")
    save_dashboard_file()